...
2) Copy these files to the location where the source code is built (.h. and .lib to fastalignapp folder) and where the application is executed (.dll to Debug or Release folder).
