...
namespace PI
{
	...
	public class GCS2
	{
		...
		*/
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_StopAll")]       public static extern int StopAll(int ID);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_SVR")]           public static extern int SVR(int ID, string sAxes, double[] dValueArray);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_EAX")]           public static extern int EAX(int ID, string sAxes, int[] iValueArray);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_MAC_qFREE")]     public static extern int MAC_qFREE(int ID, ref int iFreeSpace);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_WAV_SWEEP")]     public static extern int WAV_SWEEP(int ID, int iWaveTableId, int iAddAppendWave, uint iStarFequencytValueInPoints, uint iStopFrequencyValueInPoints, uint nLengthOfWave, double dAmplitudeOfWave, double dOffsetOfWave);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qWGS")]          public static extern int qWGS(int ID, int iWaveGeneratorId, string sItems, StringBuilder sBuffer, int iBufferSize);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qTWE")]          public static extern int qTWE(int ID, int[] iWaveTableIdsArray, int[] iWaveTableStartIndexArray, int[] iWaveTableEndIndexArray, int iArraySize);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qGFL")]          public static extern int qGFL(int ID, ref int iNumberOfRecordedFrequencyMeasurements);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qGFR")]          public static extern int qGFR (int ID, int[] iTableIdsArray, int iNumberOfTables, int iOffsetOfFirstPointInTable, int iNumberOfValues, ref IntPtr dValueArray, StringBuilder sGcsArrayHeader, int iGcsArrayHeaderMaxSize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_WFR")]           public static extern int WFR(int ID, string sAxes, double dPos, int iSource, double dAmpl, double dLowFrq, double dHighFrq, int iSweepSteps, int iSweepMode, double dVelOffset); 
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qWFR")]          public static extern int qWFR(int ID, StringBuilder sBuffer, int iBufferSize); 
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_TSP")]           public static extern int TSP(int ID, int[] iSensorsChannelsArray, double[] dValueArray, int iArraySize);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qAPG")]          public static extern int qAPG(int ID, int[] iPIEZOWALKChannelsArray, int[] iValueArray, int iArraySize);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_OSMf")]          public static extern int OSMf(int ID, int[] iPIEZOWALKChannelsArray, double[] dValueArray, int iArraySize);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_OSMstringIDs")]  public static extern int OSMstringIDs(int ID, string sAxisOrChannelIds, double[] dValueArray);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qOSMstringIDs")] public static extern int qOSMstringIDs(int ID, string sAxisOrChannelIds, double[] dValueArray);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qOSNstringIDs")] public static extern int qOSNstringIDs(int ID, string sAxisOrChannelIds, int[] iValueArray);
        ...
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_WriteConfigurationFromDatabaseToController")]             public static extern int WriteConfigurationFromDatabaseToController(int ID, string sFilter, string sConfigurationName, string sWarnings, int warningsBufferSize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_ReadConfigurationFromControllerToDatabase")]              public static extern int ReadConfigurationFromControllerToDatabase(int ID, string sFilter, string sConfigurationName, string sWarnings, int warningsBufferSize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_GetAvailableControllerConfigurationsFromDatabase")]       public static extern int GetAvailableControllerConfigurationsFromDatabase(int ID, string sConfigurationNames, int configurationNamesBufferSize);
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_GetAvailableControllerConfigurationsFromDatabaseByType")] public static extern int GetAvailableControllerConfigurationsFromDatabaseByType(int ID, string sConfigurationNames, int configurationNamesBufferSize, uint type);
        ...
        /////////////////////////////////////////////////////////////////////////////
        /// Surface scan
        DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_FSF")]                        public static extern int FSF(int ID, string sAxis, double forceValue1, double positionOffset, int useForceValue2, double forceValue2);
        DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qFSF")]                       public static extern int qFSF(int ID, string sAxes, double[] pForceValue1Array, double[] pPositionOffsetArray, double[] pForceValue2Array);
        DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_qFSR")]                       public static extern int qFSR(int ID, string sAxes, int[] pbValueArray);

        /////////////////////////////////////////////////////////////////////////////
        /// PIRest commands
        [DllImport("PI_GCS2_DLL.dll", EntryPoint = "PI_POL")]                       public static extern int POL(int ID, string sAxes, int[] iValueArray);
    }
}
