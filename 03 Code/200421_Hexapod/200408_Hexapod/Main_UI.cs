...
namespace Hexapod
{
    ...
    public partial class Main_UI : Form
    {
        ...
        public Main_UI()
        {
            ...
            Process = new SeqProcess(this);
        }
        #endregion

        #region 멤버
        public event EventHandler<DataEventArgs> UpdateData;
        public SeqProcess Process;
        ...
        private void btnMakeHardware_Click(object sender, EventArgs e)
        {
            ...
            DesignEventArgs.RegisterData = SetData.HardWareData;
        ...
        private void btnCalculateVector_Click(object sender, EventArgs e)
        {
            ...
            MovingEventArgs.RegisterData = SetData.CalculateMovingVector;
        ...
        private void btnSetTarget_Click(object sender, EventArgs e)
        {
            ...
            TargetDataEventArgs.RegisterData = SetData.TargetCoordinate;
